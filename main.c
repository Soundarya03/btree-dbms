...
void main()
{
    ...
    {
        case 1:
        ins:printf("Enter value to be inserted\n");
        scanf("%d",&value);
        insert(root,value);
        ...
        break;
        case 2:
        del:printf("Enter the value to be deleted\n");
        scanf("%d",&value);
        ...
        break;
        case 3:
        search:printf("Enter the value to be searched\n");
        scanf("%d",&value);
        result=search(root,value);
        if(result!=NULL) printf("Value %d is present\n",&result);
